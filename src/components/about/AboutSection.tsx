    ...
    >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12">
        ...
        >
          ...
          >
            <div className="flex items-center space-x-2 text-[#9CFF4A] font-bold">
        ...
        >
          <div className="font-mono text-xs text-[#9CFF4A] tracking-widest uppercase mb-2 flex items-center space-x-2">
