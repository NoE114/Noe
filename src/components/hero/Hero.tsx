  ...
  ({ onHoverTarget, onExploreProjects, isLoaded = false }, ref) => {
    ...
    return (
      ...
      <div className="my-auto py-12 relative z-10">
        <div className="max-w-5xl">
          ...
          <motion.div
            ...
            className="mt-8 max-w-2xl border-l-2 border-[#9CFF4A]/30 pl-4 sm:pl-6"
          >
      ...
      <motion.div
        ...
        className="flex flex-col sm:flex-row sm:items-end justify-between gap-6 pt-6 border-t border-[#9CFF4A]/10 font-mono text-xs"
      >
